...
;slavemacros
		...
		endm send	 
   ;=====================================================================================     
	recieve macro char	;lw char be 0feh yb2a kda elrecieve ma7asalsh
		local waitt
	waitt:	mov dx,3fdh
			in al,dx
			test al,1
...
;endd:    			
    ...
    recieve3 macro var,c1	
	  ...
	  local endd
		recieve c1
		;mov al,c1
		; cmp al,0feh  ;msh 3arf leha lazma wla la2
		; jne l1
		; mov al,0feh
		; mov c1,al
		; jmp e1
...
.DATA
	...
	;slave
	vr db ? ;variable recieved
    vs db ? ;variable to send 
	begin db 0
	;master
	vr2 db ?
    var db ?          
...
els: send 'k' ;ma3nah eno madassh haga	
endd11:	
ret
setdirection2 endp 
